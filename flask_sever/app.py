...
ecc = Social.Eco_friendly_car_registration()  # 전기차 수, 수소차 수
...
# 전기 파이, 수소 파이, 경제 막대, 환경 막대, 기술 막대,사회막대, 정규분포 1, 정규분포 2, 정규분포 3,정규분포4, 최종입지
...
# 베이지안 네트워크 화면
bayesian_layout = bayesian_network.bayesian_elec_chart
